...
- `internet_search` (Enterprise; fallback: `search_papers` for academic content, or ask user for URLs) (query: "[specific method] applied example [setting]") → find examples of how other papers handle the same methodological challenge the referee raises.
