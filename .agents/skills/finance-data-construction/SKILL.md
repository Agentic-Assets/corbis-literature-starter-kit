...
When generating code, default to Python unless the user specifies R or Stata. Use clear variable names, comment every non-obvious step, and log all output.
