...
- `internet_search` (Enterprise; fallback: `search_papers` for academic content, or ask user for URLs) (query: `"site:ssrn.com [paper topic]"`) → check for recent working papers that could be scooping risks (feeds into Agent 6 Part 4).
