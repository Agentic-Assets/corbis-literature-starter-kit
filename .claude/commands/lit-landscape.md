...
2. Merge new papers into `output/paper_set.json`, append searches to `output/search_log.md`, and save a current-topic subset to `output/lit_landscape_data.json`.
